...
export default function FabricaPage() {
  return (
    <main style={{ background: "#1A1108", color: "#F5F0E8" }}>
      ...
      {/* HERO */}
      <section style={{ minHeight: "80vh", display: "flex", flexDirection: "column", justifyContent: "flex-end", padding: "0 80px 80px", background: "radial-gradient(ellipse 60% 80% at 20% 50%, rgba(200,114,10,0.1) 0%, transparent 60%), #1A1108", paddingTop: 120 }}>
