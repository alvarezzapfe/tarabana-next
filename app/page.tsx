    ...
    <main style={{ background: "#1A1108", color: "#F5F0E8" }}>
      ...
      <section style={{
        ...
        <div style={{ position: "relative", marginBottom: 52, width: 340, height: 340 }}>
          ...
          <div style={{ position: "relative", zIndex: 2, width: 340, height: 340, display: "flex", alignItems: "center", justifyContent: "center", background: "#fff", borderRadius: "50%", boxShadow: "0 8px 40px rgba(0,0,0,0.3)" }}>
